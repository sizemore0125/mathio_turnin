...
const ClockProblem = ({ match, history }) => {
  ...
  return (
    <React.Fragment>
      ...
      <div className="heading">
        ...
        <h2 className="shape-instructions">{qtext}</h2>
        <button
          className="submit"
          type="submit"
          onClick={() => {
            handleSubmit(`${minute},${hour}`, match);
          }}
        >
          Submit
        </button>
      ...
      <div className="clock-container">
        <Clock setMinute={setMinute} setHour={setHour}></Clock>
      </div>
    </React.Fragment>
  );
};
